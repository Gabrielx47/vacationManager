...
insert into FERIAS (id, inicio, fim, status, servidor_id) values (2, '2023-09-10', '2023-09-20', 'EMANALISE', 2);
insert into FERIAS (id, inicio, fim, status, servidor_id) values (3, '2023-10-05', '2023-10-12', 'REPROVADA', 3);
